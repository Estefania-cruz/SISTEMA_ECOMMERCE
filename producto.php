...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			<section>
				<div class="part1">
					<img id="idimg" src="assets/productos/p2.jpg">
				</div>
				<div class="part2">
					<h2 id="idtitle">NOMBRE PRINCIPAL</h2>
					<h1 id="idprice">MX/. 35.<span>99</span></h1>
	...
	<script type="text/javascript">
				...
				success:function(data){
					...
					for (var i = 0; i < data.datos.length; i++) {
						if (data.datos[i].codpro==p) {
							document.getElementById("idimg").src="assets/productos/"+data.datos[i].rutimapro;
						...
						'<div class="product-box">'+
							'<a href="producto.php?p='+data.datos[i].codpro+'">'+
								'<div class="product">'+
									'<img src="assets/productos/'+data.datos[i].rutimapro+'">'+
		...
		function formato_precio(valor){
			...
			return "MX/. "+array[0]+".<span>"+array[1]+"</span>";
		}
